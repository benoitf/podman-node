...
export class SecurityInfo {
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            'name': 'apparmorEnabled',
            'baseName': 'apparmorEnabled',
            'type': 'boolean',
            'format': '',
        },
        {
        ...
        {
            'name': 'seccompEnabled',
            'baseName': 'seccompEnabled',
            'type': 'boolean',
            'format': '',
        },
        {
            'name': 'seccompProfilePath',
            'baseName': 'seccompProfilePath',
            'type': 'string',
            'format': '',
        },
        {
            'name': 'selinuxEnabled',
            'baseName': 'selinuxEnabled',
            'type': 'boolean',
            'format': '',
        }    ];

    static getAttributeTypeMap() {
        return SecurityInfo.attributeTypeMap;
    }
