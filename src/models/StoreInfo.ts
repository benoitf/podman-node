...
export class StoreInfo {
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            'name': 'containerStore',
            'baseName': 'containerStore',
            'type': 'ContainerStore',
            'format': '',
        },
        {
            'name': 'graphDriverName',
            'baseName': 'graphDriverName',
            'type': 'string',
            'format': '',
        },
        {
            'name': 'graphOptions',
            'baseName': 'graphOptions',
            'type': '{ [key: string]: any; }',
            'format': '',
        },
        {
        ...
        {
            'name': 'graphRootAllocated',
            'baseName': 'graphRootAllocated',
            'type': 'number',
            'format': 'uint64',
        },
        {
            'name': 'graphRootUsed',
            'baseName': 'graphRootUsed',
            'type': 'number',
            'format': 'uint64',
        },
        {
            'name': 'graphStatus',
            'baseName': 'graphStatus',
            'type': '{ [key: string]: string; }',
            'format': '',
        },
        {
            'name': 'imageCopyTmpDir',
            'baseName': 'imageCopyTmpDir',
            'type': 'string',
            'format': '',
        },
        {
    ...
    static getAttributeTypeMap() {
        return StoreInfo.attributeTypeMap;
    }
