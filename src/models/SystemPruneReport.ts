...
export class SystemPruneReport {
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            'name': 'containerPruneReports',
            'baseName': 'ContainerPruneReports',
            'type': 'Array<PruneReport>',
            'format': '',
        },
        {
            'name': 'imagePruneReports',
            'baseName': 'ImagePruneReports',
            'type': 'Array<PruneReport>',
            'format': '',
        },
        {
            'name': 'podPruneReport',
            'baseName': 'PodPruneReport',
            'type': 'Array<PodPruneReport>',
            'format': '',
        },
        {
            'name': 'reclaimedSpace',
            'baseName': 'ReclaimedSpace',
            'type': 'number',
            'format': 'uint64',
        },
        {
            'name': 'volumePruneReports',
            'baseName': 'VolumePruneReports',
            'type': 'Array<PruneReport>',
            'format': '',
        }    ];

    static getAttributeTypeMap() {
        return SystemPruneReport.attributeTypeMap;
    }
